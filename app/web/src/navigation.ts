export const routes = [
  ...
  {path:'/library/folders',group:'library',label:'文件夹视图',mode:'folders'},
  {path:'/library/unpublished',group:'library',label:'未填发布信息',mode:'unpublished'},
  {path:'/library/manage',group:'library',label:'素材库管理',mode:'manage'},
